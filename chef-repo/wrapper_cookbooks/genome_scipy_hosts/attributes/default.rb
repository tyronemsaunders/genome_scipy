# Cookbook Name:: genome_scipy_hosts
# Attribute:: default
#
...
jupyter_notebooks = node['deploy']['jupyter'][node.chef_environment]
...
jupyter_notebooks.each do |jn|
  aliases.push("#{jn['subdomain']}.#{jn['domain']}")
  aliases.push(jn['subdomain'])
end
